        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Issued Students Accessories</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Issued Students Accessories</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                        <h3 class="card-title">
                                            List of issued students accessories with the list of students issued
                                            to.
                                        </h3>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="#">Exercise Book</a></td>
                                                <td>English book</td>
                                                <td>4719</td>
                                                <td><a href="#">Shadrack Kipchumba</a></td>
                                                <td>F4</td>
                                                <td>1</td>
                                                <td>29/09/2023</td>
                                                <td>N/A</td>
