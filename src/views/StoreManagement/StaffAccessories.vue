        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Staff Accessories</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Staff Accessories</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <RouterLink to="/issued_staff_accessories"><button class="btn btn-success mb-2 float-right">
                                    Check Issued Accessories
                                </button></RouterLink>
                        </div>
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between">
                                        <h3 class="card-title">
                                            List of staff accessories available in school
                                        </h3>

                                        <RouterLink to="/issue_staff_accessory">
                                            <button class="btn btn-info">Issue Accessory</button>
                                        </RouterLink>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>LGG12</td>
                                                <td>Locker</td>
                                                <td>Locker number 12. or any description</td>
                                                <td>10 cc</td>
                                                <td>170 cc</td>
                                                <td>28/09/2023</td>
