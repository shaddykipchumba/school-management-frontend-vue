              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header m-0">
                    <h3 class="card-title">List of Fee structures with consiquent Terms</h3>
                    <RouterLink to="/create_fee"><button class="btn btn-info float-right">Create Fee</button></RouterLink>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
